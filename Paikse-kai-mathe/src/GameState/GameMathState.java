...
public class GameMathState extends GameState {
	...
	public void render(Graphics2D g) {
        ...
        g.drawString("Πατήστε ESC για το μενού επιλογών", (int)(GamePanel.WIDTH/6.0), (int) (GamePanel.HEIGHT*(9.5/10)));
		...
		//αν τελειώσουν οι ερωτήσεις και δεν ειναι ορατό το messageBox, 
