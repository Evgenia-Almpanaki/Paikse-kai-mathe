...
public class GameStateManager {
	...
	public static final int SCORE_DISPLAY_STATE = 2;
	public static final int PAUSE_MENU_STATE = 3;
	public static final int INPUT_STATE = 4;
	public static final int DIFFICULTY_STATE = 5;
	public static final int PLAYING_MENU_STATE = 6;
	public static final int GAME_OVER_STATE = 7;
	public static final int GAME_HISTORY_STATE = 8;
	public static final int GAME_GRAMMAR_STATE = 9;
	public static final int GAME_GEOGRAPHY_STATE = 10;
	public static final int GAME_MATH_STATE = 11;
	...
	public void generateStates(int loadPhase){
